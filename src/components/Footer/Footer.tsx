            ...
            <div className='container'>
                ...
                <div className='mt-10 text-center text-sm'>
                    ...
                    <div className='mt-2'>
                        ...
                        Nội, Việt Nam. Chăm sóc khách hàng: Gọi tổng đài Shopee
                        (miễn phí) hoặc Trò chuyện với Shopee ngay trên Trung
                        tâm trợ giúp
                    </div>
                    <div className='mt-2'>
                    ...
                    <div className='mt-2'>
                        Mã số doanh nghiệp: 0106773786 do Sở Kế hoạch và Đầu tư
