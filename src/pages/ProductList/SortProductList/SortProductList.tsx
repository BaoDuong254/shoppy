      ...
      <div className='flex flex-wrap items-center justify-between gap-2'>
        ...
        <div className='flex items-center'>
          ...
          <div className='ml-2'>
            <button
              type='button'
              className='h-8 cursor-not-allowed rounded-bl-sm rounded-tl-sm bg-white/60 px-3 shadow hover:bg-slate-100'
            >
              <svg
            ...
            <button type='button' className='h-8 rounded-br-sm rounded-tr-sm bg-white px-3 shadow hover:bg-slate-100'>
              <svg
                xmlns='http://www.w3.org/2000/svg'
                fill='none'
                viewBox='0 0 24 24'
