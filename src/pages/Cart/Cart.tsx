                ...
                <div className='grid grid-cols-12 rounded-sm bg-white px-9 py-5 text-sm capitalize text-gray-500 shadow'>
                  <div className='col-span-6'>
                    <div className='flex items-center'>
                      ...
                      <div className='flex-grow text-black'>{t("cart products")}</div>
                    </div>
                  </div>
                  <div className='col-span-6'>
                    <div className='grid grid-cols-5 text-center'>
                      ...
                      <div className='col-span-1'>{t("operations")}</div>
                    </div>
                  </div>
                </div>
                {extendedPurchases.length > 0 && (
                          ...
                          <div className='flex'>
                            <div className='flex flex-shrink-0 items-center justify-center pr-3'>
                              <input
                                ...
                                aria-label={`Select purchase ${purchase.product.name}`}
                              />
                            </div>
              ...
              <div className='flex items-center'>
                <div className='flex flex-shrink-0 items-center justify-center pr-3'>
                  <input
                    ...
                    checked={isAllChecked}
                    onChange={handleCheckAll}
                    aria-label='Select all purchases for deletion'
                  />
                </div>
                <button className='mx-3 border-none bg-none' onClick={handleCheckAll} type='button'>
                  {t("select all")} ({extendedPurchases.length})
                </button>
                <button className='mx-3 border-none bg-none' onClick={handleDeleteManyPurchases} type='button'>
                  {t("delete")}
                </button>
              </div>
              ...
              <div className='mt-5 flex flex-col sm:ml-auto sm:mt-0 sm:flex-row sm:items-center'>
                <div>
                  <div className='flex items-center sm:justify-end'>
                    <div>
                      {t("select all")} ({checkedPurchasesCount} {t("cart products")}):
                    </div>
