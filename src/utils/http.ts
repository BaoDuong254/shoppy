  ...
  constructor() {
    ...
    this.instance = axios.create({
      ...
      headers: {
        ...
        "expire-access-token": 60 * 60 * 24, // 24h
        "expire-refresh-token": 60 * 60 * 24 * 30, // 30 days
      },
    });
    ...
    this.instance.interceptors.response.use(
      ...
      async (error: AxiosError) => {
        if (
          ![HttpStatusCode.UnprocessableEntity as number, HttpStatusCode.Unauthorized as number].includes(
